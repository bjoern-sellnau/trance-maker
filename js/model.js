...
export const PRESETS = [
  ...
  { category: 'Techno', name: 'Rumble Bass', type: 'synth', wave: 'sawtooth', cutoff: 400, q: 4, sub: 0.5, attack: 0.005, decay: 0.3, sustain: 0.6, release: 0.2, drive: 0.2, gain: 0.5 },
  { category: 'Techno', name: 'Acid Lead', type: 'synth', wave: 'sawtooth', cutoff: 700, q: 16, decay: 0.2, sustain: 0.3, release: 0.1, drive: 0.35, gain: 0.45 },
  { category: 'Techno', name: 'Techno Stab', type: 'synth', wave: 'square', fat: true, cutoff: 3000, q: 3, attack: 0.004, decay: 0.2, sustain: 0.2, release: 0.2, gain: 0.4 },
  { category: 'Techno', name: 'Bleep', type: 'synth', wave: 'sine', cutoff: 6000, attack: 0.001, decay: 0.1, sustain: 0, release: 0.08, gain: 0.5 },
  { category: 'Techno', name: 'Techno Clap', type: 'drum', drum: 'clap', decay: 0.2, gain: 0.7 },
  { category: 'Techno', name: 'Ride', type: 'drum', drum: 'hat', decay: 0.5, cutoff: 9000, gain: 0.35 },
  { category: 'Techno', name: 'Perc', type: 'drum', drum: 'tom', tune: 180, decay: 0.18, pitched: true, gain: 0.6 },
  { category: 'Techno', name: 'Hoover Stab', type: 'synth', wave: 'sawtooth', fat: true, detune: 20, cutoff: 3500, q: 2, decay: 0.25, sustain: 0.4, drive: 0.3, gain: 0.4 },
  { category: 'Techno', name: 'Dark Pad', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 1800, q: 1, attack: 0.5, sustain: 0.85, release: 1, gain: 0.3 },
  // House
  { category: 'House', name: 'House Kick', type: 'drum', drum: 'kick', tune: 50, decay: 0.34, click: 0.3 },
  { category: 'House', name: 'House Bass', type: 'synth', wave: 'sawtooth', cutoff: 600, q: 3, sub: 0.4, attack: 0.004, decay: 0.2, sustain: 0.3, release: 0.12, gain: 0.55 },
  { category: 'House', name: 'Piano Stab', type: 'synth', wave: 'triangle', attack: 0.002, decay: 0.4, sustain: 0, release: 0.3, cutoff: 5000, gain: 0.55 },
  { category: 'House', name: 'Organ Stab', type: 'synth', wave: 'square', attack: 0.005, decay: 0.2, sustain: 0.7, release: 0.15, cutoff: 4000, gain: 0.4 },
  { category: 'House', name: 'House Pluck', type: 'synth', wave: 'sawtooth', cutoff: 4000, q: 4, attack: 0.002, decay: 0.18, sustain: 0, release: 0.14, gain: 0.5 },
  { category: 'House', name: 'Clap 909', type: 'drum', drum: 'clap', decay: 0.24, gain: 0.75 },
  { category: 'House', name: 'Shaker', type: 'drum', drum: 'hat', decay: 0.06, cutoff: 10000, gain: 0.4 },
  { category: 'House', name: 'Vocal Chord', type: 'synth', wave: 'sawtooth', fat: true, detune: 10, cutoff: 3000, attack: 0.05, decay: 0.4, sustain: 0.7, release: 0.4, gain: 0.34 },
  { category: 'House', name: 'Deep Chord', type: 'synth', wave: 'triangle', fat: true, cutoff: 2500, attack: 0.08, sustain: 0.8, release: 0.5, gain: 0.34 },
  { category: 'House', name: 'Filter Bass', type: 'synth', wave: 'sawtooth', cutoff: 900, q: 6, sub: 0.3, decay: 0.25, sustain: 0.4, drive: 0.15, gain: 0.5 },
  // Dubstep
  { category: 'Dubstep', name: 'Wobble Bass', type: 'synth', wave: 'sawtooth', fat: true, sub: 0.4, cutoff: 700, q: 12, decay: 0.3, sustain: 0.6, drive: 0.5, detune: 20, gain: 0.5 },
  { category: 'Dubstep', name: 'Growl Bass', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 900, q: 10, decay: 0.25, sustain: 0.6, drive: 0.6, detune: 24, gain: 0.45 },
  { category: 'Dubstep', name: 'Dub Sub', type: 'synth', wave: 'sine', cutoff: 2000, sustain: 0.9, gain: 0.7 },
  { category: 'Dubstep', name: 'Dub Snare', type: 'drum', drum: 'snare', tune: 200, decay: 0.2, drive: 0.2, gain: 0.75 },
  { category: 'Dubstep', name: 'Dub Kick', type: 'drum', drum: 'kick', tune: 55, decay: 0.3, click: 0.5, drive: 0.3 },
  { category: 'Dubstep', name: 'Dub Screech', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 5000, q: 8, decay: 0.3, sustain: 0.6, drive: 0.5, gain: 0.3 },
  { category: 'Dubstep', name: 'Dub Reese', type: 'synth', wave: 'sawtooth', fat: true, detune: 28, cutoff: 800, q: 3, sub: 0.3, sustain: 0.7, drive: 0.25, gain: 0.45 },
  { category: 'Dubstep', name: 'Dub FX', type: 'drum', drum: 'hat', decay: 0.6, cutoff: 6000, gain: 0.4 },
  // Drum & Bass
  { category: 'DnB', name: 'Reese Bass DnB', type: 'synth', wave: 'sawtooth', fat: true, detune: 30, cutoff: 700, q: 4, sub: 0.3, sustain: 0.7, drive: 0.3, gain: 0.45 },
  { category: 'DnB', name: 'Sub Bass DnB', type: 'synth', wave: 'sine', cutoff: 1800, sustain: 0.9, gain: 0.7 },
  { category: 'DnB', name: 'DnB Snare', type: 'drum', drum: 'snare', tune: 240, decay: 0.16, gain: 0.78 },
  { category: 'DnB', name: 'DnB Kick', type: 'drum', drum: 'kick', tune: 52, decay: 0.26, click: 0.45 },
  { category: 'DnB', name: 'Amen Hat', type: 'drum', drum: 'hat', decay: 0.05, cutoff: 9000, gain: 0.4 },
  { category: 'DnB', name: 'DnB Stab', type: 'synth', wave: 'square', fat: true, cutoff: 3500, q: 3, decay: 0.2, sustain: 0.3, gain: 0.4 },
  { category: 'DnB', name: 'DnB Pad', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 2200, attack: 0.4, sustain: 0.85, release: 0.9, gain: 0.3 },
  { category: 'DnB', name: 'DnB Lead', type: 'synth', wave: 'sawtooth', cutoff: 5000, q: 2, decay: 0.3, sustain: 0.6, release: 0.3, gain: 0.4 },
  // Ambient
  { category: 'Ambient', name: 'Warm Pad 2', type: 'synth', wave: 'triangle', fat: true, cutoff: 2000, attack: 0.7, sustain: 0.85, release: 1.2, gain: 0.32 },
  { category: 'Ambient', name: 'Glass Pad', type: 'synth', wave: 'sine', fat: true, cutoff: 4000, attack: 0.6, sustain: 0.8, release: 1.0, gain: 0.3 },
  { category: 'Ambient', name: 'Drone', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 1500, attack: 1.0, sustain: 0.9, release: 1.5, gain: 0.28 },
  { category: 'Ambient', name: 'Bell Pad', type: 'synth', wave: 'sine', attack: 0.01, decay: 1.0, sustain: 0.3, release: 0.8, cutoff: 6000, gain: 0.4 },
  { category: 'Ambient', name: 'Choir Air', type: 'synth', wave: 'sawtooth', fat: true, detune: 8, cutoff: 3000, attack: 0.5, sustain: 0.9, release: 1.0, gain: 0.3 },
  { category: 'Ambient', name: 'Air', type: 'synth', wave: 'sine', attack: 0.8, sustain: 0.7, release: 1.2, cutoff: 7000, gain: 0.25 },
  { category: 'Ambient', name: 'Sub Pad', type: 'synth', wave: 'sine', attack: 0.4, sustain: 0.9, release: 1.0, cutoff: 1200, gain: 0.4 },
  { category: 'Ambient', name: 'Soft Pluck', type: 'synth', wave: 'triangle', attack: 0.005, decay: 0.4, sustain: 0, release: 0.4, cutoff: 3500, gain: 0.45 },
  { category: 'Ambient', name: 'Deep Drone', type: 'synth', wave: 'sawtooth', fat: true, cutoff: 900, attack: 1.2, sustain: 0.9, release: 2, gain: 0.26 },
  // Brass & Wind
  { category: 'Brass & Wind', name: 'Trumpet', type: 'synth', wave: 'sawtooth', attack: 0.02, decay: 0.2, sustain: 0.85, release: 0.2, cutoff: 4000, drive: 0.1, gain: 0.4 },
  { category: 'Brass & Wind', name: 'Trombone', type: 'synth', wave: 'sawtooth', attack: 0.04, sustain: 0.85, release: 0.25, cutoff: 2800, gain: 0.42 },
  ...
  { category: 'Brass & Wind', name: 'Brass Section', type: 'synth', wave: 'sawtooth', fat: true, detune: 8, attack: 0.03, sustain: 0.85, release: 0.3, cutoff: 3800, drive: 0.1, gain: 0.36 },
  // World
  { category: 'World', name: 'Sitar', type: 'synth', wave: 'sawtooth', attack: 0.002, decay: 0.5, sustain: 0.1, release: 0.3, cutoff: 4000, q: 3, drive: 0.2, gain: 0.45 },
  { category: 'World', name: 'Koto', type: 'synth', wave: 'triangle', attack: 0.002, decay: 0.5, sustain: 0, release: 0.3, cutoff: 5000, gain: 0.5 },
  { category: 'World', name: 'Shamisen', type: 'synth', wave: 'square', attack: 0.002, decay: 0.4, sustain: 0, release: 0.25, cutoff: 4500, gain: 0.45 },
  { category: 'World', name: 'Banjo', type: 'synth', wave: 'square', attack: 0.002, decay: 0.35, sustain: 0, release: 0.2, cutoff: 5500, gain: 0.45 },
  { category: 'World', name: 'Akkordeon', type: 'synth', wave: 'sawtooth', fat: true, detune: 6, attack: 0.03, sustain: 0.85, release: 0.25, cutoff: 3500, gain: 0.35 },
  { category: 'World', name: 'Mundharmonika', type: 'synth', wave: 'square', attack: 0.02, sustain: 0.85, release: 0.2, cutoff: 3500, drive: 0.15, gain: 0.4 },
  { category: 'World', name: 'Okarina', type: 'synth', wave: 'sine', attack: 0.03, sustain: 0.9, release: 0.25, cutoff: 5000, gain: 0.45 },
  { category: 'World', name: 'Balafon', type: 'synth', wave: 'triangle', attack: 0.001, decay: 0.4, sustain: 0, release: 0.3, cutoff: 4200, gain: 0.5 },
  { category: 'World', name: 'Steelpan 2', type: 'synth', wave: 'triangle', attack: 0.002, decay: 0.5, sustain: 0.1, release: 0.3, cutoff: 4500, drive: 0.12, gain: 0.5 },
  { category: 'World', name: 'Mbira', type: 'synth', wave: 'sine', attack: 0.001, decay: 0.5, sustain: 0, release: 0.35, cutoff: 5000, gain: 0.5 },
  // FX
  { category: 'FX', name: 'Riser', type: 'drum', drum: 'hat', decay: 1.2, cutoff: 5000, gain: 0.4 },
  { category: 'FX', name: 'Downlifter', type: 'drum', drum: 'tom', tune: 200, decay: 0.8, pitched: true, gain: 0.5 },
  { category: 'FX', name: 'Impact', type: 'drum', drum: 'kick', tune: 45, decay: 0.6, click: 0.6, drive: 0.3, gain: 0.9 },
  { category: 'FX', name: 'Sub Drop', type: 'drum', drum: 'kick', tune: 40, decay: 0.7, pitched: true, gain: 0.85 },
  { category: 'FX', name: 'Zap', type: 'synth', wave: 'square', attack: 0.001, decay: 0.08, sustain: 0, release: 0.05, cutoff: 7000, drive: 0.3, gain: 0.4 },
  { category: 'FX', name: 'Laser', type: 'synth', wave: 'sawtooth', attack: 0.001, decay: 0.12, sustain: 0, release: 0.06, cutoff: 9000, gain: 0.4 },
  { category: 'FX', name: 'Noise Sweep', type: 'drum', drum: 'hat', decay: 0.9, cutoff: 7000, gain: 0.4 },
  { category: 'FX', name: 'White Hit', type: 'drum', drum: 'hat', decay: 0.1, cutoff: 8000, gain: 0.5 },
  { category: 'FX', name: 'Reverse Cymbal', type: 'drum', drum: 'hat', decay: 1.0, cutoff: 6000, gain: 0.35 },
  { category: 'FX', name: 'Blip FX', type: 'synth', wave: 'square', attack: 0.001, decay: 0.06, sustain: 0, release: 0.04, cutoff: 9000, gain: 0.4 }
];
